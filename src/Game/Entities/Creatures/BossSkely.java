 ...
 */
public class BossSkely extends CreatureBase  {
    ...
    public BossSkely(Handler handler, float x, float y) {
        ...
        animDown = new Animation(animWalkingSpeed, Images.SkelyBoss_front);
        animLeft = new Animation(animWalkingSpeed,Images.SkelyBoss_left);
        animRight = new Animation(animWalkingSpeed,Images.SkelyBoss_right);
        animUp = new Animation(animWalkingSpeed,Images.SkelyBoss_back);
