 ...
 */
public class OpSkely extends CreatureBase  {
    ...
    public OpSkely(Handler handler, float x, float y) {
        ...
        animDown = new Animation(animWalkingSpeed, Images.SkelyOP_front);
        animLeft = new Animation(animWalkingSpeed,Images.SkelyOP_left);
        animRight = new Animation(animWalkingSpeed,Images.SkelyOP_right);
        animUp = new Animation(animWalkingSpeed,Images.SkelyOP_back);
    ...
    public void render(Graphics g) {
        g.drawImage(getCurrentAnimationFrame(animDown,animUp,animLeft,animRight,Images.SkelyOP_front,Images.SkelyOP_back,Images.SkelyOP_left,Images.SkelyOP_right), (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
    ...
    public void die() {
    	...
    	handler.getWorld().getItemManager().addItem(Item.swordItem.createNew((int)x + bounds.x,(int)y + bounds.y,1));
