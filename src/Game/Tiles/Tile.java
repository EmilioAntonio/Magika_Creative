...
public class Tile {
    ...
    //new tiles
    public static Tile iceTile = new IceTile(15);
    public static Tile iceStoneTile = new IceStoneTile(Images.blocks[16], 16);
    public static Tile icePillarTile = new IcePillar(Images.blocks[17], 17);
